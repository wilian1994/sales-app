...
export class AddProductsComponent implements OnInit {
  ...
  ngOnInit() {
    this.categoriessService.listAll().subscribe((categories: any) => this.categories$ = categories);
    this.id = this.route.snapshot.params['id'];
    if(this.id){
      this.productsService.view(this.id).subscribe((product: Product) => this.createForm(product));
      return;
    }
  ...
  private save(){
    ...
    if(this.register.valid){
      ...
      this.productsService.save(data)
      .subscribe(
